...
export class CompetitionTypePipe implements PipeTransform {
  private CompetitionTypes = {
    "basic_final": "Final",
    "basic_semi_max_9": "Round before the Final, if Final is of max. 9 athletes",
    "basic_semi_more_9": "Round before the Final, if Final is of 10 or more athletes",
    "extra_final": "Final",
    "extra_semi_ow": "Round before the Final in Olympics/World Championships",
    "extra_semi_max_9": "Round before the Final, if Final is of max. 9 athletes",
    "extra_semi_more_9": "Round before the Final, if Final is of 10 or more athletes",
